...
# H0: E[Y(1)-Y(0)|G_i = 1] = E[Y(1)-Y(0)|G_i = 0]

# If both W_i and G_i are binary, then

#   E[Y_i(W_i)|G_i]
# = E[Y_i|W_i, G_i] 
# = beta_0 + beta_w * W_i + beta_g * G_i + beta_wg *  W_i *  G_i

# E[Y(1)|G_i = 1] = beta_0 + beta_w * W_i + beta_g * G_i + beta_wg *  W_i *  G_i
...
# 4.3 Assessing heterogeneity with RATE
